...
- (BOOL)isValidPhoneNum{
     ...
     */
    NSString *MOBILE = @"^1(3[0-9]|4[0-9]|5[0-35-9]|8[0-9]|7[0678])\\d{8}$";
    /**
     * 中国移动：China Mobile
     * 134,135,136,137,138,139,150,151,152,157,158,159,182,183,184,187,188,147,178,1705
     */
    NSString *CM = @"(^1(3[0-9]|4[0-9]|5[0-27-9]|7[0-9]|8[2-478])\\d{8}$)|(^1705\\d{7}$)";
    /**
     * 中国联通：China Unicom
     * 130,131,132,155,156,185,186,145,176,1709
     */
    NSString *CU = @"(^1(3[0-9]|4[0-9]|5[56]|7[0-9]|8[56])\\d{8}$)|(^1709\\d{7}$)";
    /**
     * 中国电信：China Telecom
...
+(NSString *)judegeNull:(NSString *)string{
    ...
    if ([string isKindOfClass:[NSNull class]] ) {//判断null
        backString  = @"";
...
+ (NSString *)getName:(NSString *)name{
    ...
    //    NSMutableString *backName =[NSMutableString stringWithString:name];
...
+(NSString *)getCurrentTimeAddEightNum{
    ...
    NSString *backString = [NSString stringWithFormat:@"%@%@",timeString,randomNumber];
...
-(NSString*)ReplacingsubStringFrom:(NSString*)startString to:(NSString*)endString andWhat:(NSInteger)num{
    ...
    NSString *cutSting = [self subStringFrom:startString to:endString];
    fistcut = cutSting;
    
    NSArray * aaaa = [cutSting componentsSeparatedByString:@":"];
    
    cutSting = [aaaa componentsJoinedByString:@""];
    
    cutSting = [self stringDeleteString:cutSting];
    
    NSLog(@"cutSting %@",cutSting);
    
    if (num == 1) {
        return cutSting;
    }else{
        if ([cutSting isEqualToString:@""]) {
            backString = self;
        }else{
            
            backString = [self stringByReplacingOccurrencesOfString:[NSString stringWithFormat:@"<@user>%@</@user>",fistcut] withString:[NSString stringWithFormat:@"@ %@:",cutSting]];
